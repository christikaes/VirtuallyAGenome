$(function(){
    ...
    for (var i = 0; i < geneList.length; i++) {
      ...
      var x = i < l ? 1.5 : 4.5;
      var y = i%l/2;
      var plane = "<a-plane class='menu' id='" + geneList[i] + "-menu' color='#3F51B5' height='0.4' width='2.5' position='" + x + " " + y + " -3'></a-plane>"
      var text =  "<a-entity bmfont-text='text: " + geneList[i] + "; color: #fff; lineHeight: 50' position='" + (x-1) + " " + y + " -2.99'></a-entity>"
      menuItems += plane;
      menuItems += text;
    }
